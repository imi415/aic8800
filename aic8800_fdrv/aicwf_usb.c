...
static int aicwf_usb_chipmatch(struct aic_usb_dev *usb_dev, u16_l vid, u16_l pid){
	...
	if(pid == USB_PRODUCT_ID_AIC8801){
		...
		return 0;
	}else if(pid == USB_PRODUCT_ID_AIC8800DC || pid == USB_PRODUCT_ID_MERCURY_UX3
      || pid == USB_PRODUCT_ID_UGREEN_AX300){
...
static struct usb_device_id aicwf_usb_id_table[] = {
    ...
    {USB_DEVICE(USB_VENDOR_ID_AIC, USB_PRODUCT_ID_UGREEN_AX300)},
    ...
    {USB_DEVICE(USB_VENDOR_ID_MERCURY, USB_PRODUCT_ID_MERCURY_UX3)},
#endif
    {}
};
